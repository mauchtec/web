...
class Unit(BaseModel):
    PERMISSIONS_CHOICES = [
        ("residence_basic", "Residence-Basic"),
        ("residence_advanced", "Residence - Advanced"),
        ("security", "Security"),
        ("amenities", "Amenities"),
    ]
    UNIT_TYPES = [
    ...
    permissions = models.CharField(max_length=32, choices=PERMISSIONS_CHOICES, default="residence_basic")
    # is_active is inherited from BaseModel

    def get_permissions_display(self):
        return dict(self.PERMISSIONS_CHOICES).get(self.permissions, self.permissions)
