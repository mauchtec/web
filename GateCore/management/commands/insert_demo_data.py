    ...
    def handle(self, *args, **options):
        ...
        sites_data = [
            ...
            },
            {
                ...
                'site_type': 'estate',
                'location': 'Trust City',
                'address': '44 Trust Avenue',
                'description': 'Demo estate with four residential units',
                'code': 'TRUSTEST',
            },
        ]
        sites = []
        ...
        properties_data = [
            ...
            # Trust Estate
            {'site': sites[4], 'name': 'Trust Block A', 'property_code': 'TRUSTA', 'address': '44 Trust Avenue', 'property_type': 'residential', 'location': 'Block A', 'total_floors': 2, 'year_built': 2026},
        ]
        properties = []
        ...
        units_data = [
            ...
            # Trust Estate
            {'property': properties[5], 'unit_code': 'T-1', 'unit_type': 'apartment', 'floor': 1, 'status': 'occupied', 'area_sqft': 820, 'bedrooms': 1, 'bathrooms': 1, 'has_parking': False, 'parking_spots': 0},
            {'property': properties[5], 'unit_code': 'T-2', 'unit_type': 'apartment', 'floor': 1, 'status': 'occupied', 'area_sqft': 840, 'bedrooms': 2, 'bathrooms': 1, 'has_parking': True, 'parking_spots': 1},
            {'property': properties[5], 'unit_code': 'T-3', 'unit_type': 'apartment', 'floor': 2, 'status': 'occupied', 'area_sqft': 860, 'bedrooms': 2, 'bathrooms': 2, 'has_parking': True, 'parking_spots': 1},
            {'property': properties[5], 'unit_code': 'T-4', 'unit_type': 'apartment', 'floor': 2, 'status': 'vacant', 'area_sqft': 900, 'bedrooms': 3, 'bathrooms': 2, 'has_parking': True, 'parking_spots': 2},
        ]
        units = []
        ...
        people_data = [
            ...
            {'first_name': 'Trust', 'last_name': 'Resident', 'phone': '0656231093', 'email': 'trust.resident@example.com', 'gender': 'M', 'phone_device_type': 'android', 'phone_otp': '246810', 'phone_otp_created': None, 'facial_recognition_enabled': True},
            {'first_name': 'Mollet', 'last_name': 'Resident', 'phone': '+27 84 286 4525', 'email': 'mollet.resident@example.com', 'gender': 'F', 'phone_device_type': 'ios', 'phone_otp': '135790', 'phone_otp_created': None, 'facial_recognition_enabled': True},
            {'first_name': 'Nyasha', 'last_name': 'Resident', 'phone': '+27 68 410 0046', 'email': 'nyasha.resident@example.com', 'gender': 'F', 'phone_device_type': 'android', 'phone_otp': '112233', 'phone_otp_created': None, 'facial_recognition_enabled': True},
            {'first_name': 'Vitalis', 'last_name': 'Resident', 'phone': '+27 81 774 7243', 'email': 'vitalis.resident@example.com', 'gender': 'M', 'phone_device_type': 'android', 'phone_otp': '445566', 'phone_otp_created': None, 'facial_recognition_enabled': True},
        ]
        people = []
        ...
        vehicles_data = [
            ...
            {'person': people[6], 'license_plate': 'TRUST1', 'vehicle_type': 'car', 'make': 'DemoMake', 'model': 'T1', 'color': 'Silver', 'year': 2025, 'fuel_type': 'petrol', 'has_sticker': True, 'sticker_number': 'TRUST-001'},
            {'person': people[7], 'license_plate': 'MOLLET1', 'vehicle_type': 'car', 'make': 'DemoMake', 'model': 'T2', 'color': 'Black', 'year': 2024, 'fuel_type': 'petrol', 'has_sticker': True, 'sticker_number': 'TRUST-002'},
        ]
        ...
        occupancies_data = [
            ...
            {'person': people[6], 'unit': units[7], 'role': 'owner', 'start_date': '2026-03-01', 'contract_number': 'TR-001', 'monthly_rent': 0, 'security_deposit': 0, 'is_primary': True},
            {'person': people[7], 'unit': units[8], 'role': 'tenant', 'start_date': '2026-03-01', 'contract_number': 'TR-002', 'monthly_rent': 2500, 'security_deposit': 2500, 'is_primary': True},
            {'person': people[8], 'unit': units[9], 'role': 'tenant', 'start_date': '2026-03-01', 'contract_number': 'TR-003', 'monthly_rent': 3000, 'security_deposit': 3000, 'is_primary': True},
            {'person': people[9], 'unit': units[10], 'role': 'tenant', 'start_date': '2026-03-01', 'contract_number': 'TR-004', 'monthly_rent': 3200, 'security_deposit': 3200, 'is_primary': True},
        ]
